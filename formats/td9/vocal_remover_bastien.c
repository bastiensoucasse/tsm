...
/**
 * @brief The structure used to hold port connection information (and gain if
...
/**
 * @brief Constructs a new plugin instance.
 */
LADSPA_Handle
...
/**
 * @brief Connects a port to a data location.
 */
...
/**
 * @brief Run a delay line instance for a block of SampleCount samples.
 */
...
/**
 * @brief Returns a descriptor of the requested plugin type.
 */
